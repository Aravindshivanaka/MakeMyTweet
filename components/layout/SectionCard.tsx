...
export default function SectionCard({
  ...
  return (
    ...
    >
      ...
      >
        {/* Left: title */}
        <h2 className={`text-xs font-semibold tracking-wider uppercase select-none flex-1 min-w-0 transition-colors duration-200 ease-in-out flex items-center gap-3 ${collapsed
      ...
      >
        <div className="px-[16px] pb-[16px] flex flex-col gap-[12px]">
          {description && (
            <p className="text-[11px] text-slate-400/90 leading-normal mt-[2px]">
              {description}
            </p>
          )}
