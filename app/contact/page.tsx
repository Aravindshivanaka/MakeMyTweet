      ...
      <main className="flex-1 max-w-xl w-full mx-auto px-6 py-16 flex flex-col items-center justify-center">
        ...
        <div className="bg-panel-bg border border-[#1E2D4A] rounded-xl p-6 w-full text-center shadow-lg hover:border-[#1D6FEB]/30 transition-all duration-300 mb-8">
          ...
          <a
            ...
            className="text-lg md:text-xl font-bold text-[#1D6FEB] hover:underline"
          >
            support@tweetss.com
          </a>
        </div>
        ...
        <div className="w-full">
          ...
          <div className="flex flex-col sm:flex-row gap-4 w-full">
            ...
            <a
              ...
              className="flex-1 inline-flex items-center justify-center gap-2 px-5 py-3.5 bg-[#0A66C2] hover:bg-[#0A66C2]/90 text-white rounded-xl font-semibold text-sm transition-all duration-300 shadow-md shadow-[#0A66C2]/10"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex-1 inline-flex items-center justify-center gap-2 px-5 py-3.5 bg-input-bg border border-[#1E2D4A] hover:bg-[#1E2D4A]/30 text-foreground rounded-xl font-semibold text-sm transition-all duration-300"
            >
              <svg viewBox="0 0 24 24" className="w-5 h-5 fill-current">
