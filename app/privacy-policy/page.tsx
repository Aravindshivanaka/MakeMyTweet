...
const POLICY_SECTIONS: PolicySection[] = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "• Uploaded avatars, organization logos, and background images are processed locally inside the browser and are not permanently stored on our servers.",
      "• All generated screenshots are created and exported locally on your device.",
      "Our website's editor and export functionality do not intentionally upload, transfer, or store your tweet content or uploaded images on Make My Tweet servers. We do not store tweet content on our servers."
    ]
  },
  {
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "Google Analytics is used for anonymous website analytics to help improve the website. No personal tweet content is collected through analytics."
    ]
  },
  {
    ...
    paragraphs: [
      ...
      "The website is hosted on Vercel, and normal server logs may be generated by the hosting provider for security and operational purposes."
    ]
  },
  {
